...
@Slf4j
public class EanSpecializedStoreController implements Initializable {

    private Stage splash;
    private MsSqlConnection defaultConnection;

    @FXML
    private TableView<Ean> eanSpecializedStoreTable;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        eanSpecializedStoreTable.setPlaceholder(new Label("Brak rekordów"));
        ...
        eanSpecializedStoreTable.setItems(eanListObs);
    }
